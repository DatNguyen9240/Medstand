...
robocopy "%SRC%" "%TMP_DIR%" /MIR /XD .git .cursor .venv .logs npm_global npm_cache .cache .bin qdrant qdrant_storage node_modules __pycache__ /XF *.zip Tao_File_Gui_Khach.bat /NJH /NJS /NDL /NC /NS /NP /R:0 /W:0 >nul
