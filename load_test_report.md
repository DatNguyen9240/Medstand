...
| :--- | :--- | :--- |
| **Tổng số nhân viên sale mô phỏng** | **5** | Tổng lượng người dùng ảo tham gia |
| **Tỷ lệ thành công (Success Rate)** | **100.00%** | Tỷ lệ phản hồi hợp lệ từ chatbot |
| **Số request thành công** | `5` | Trả về dữ liệu/câu trả lời hợp lệ |
| **Số request thất bại** | `0` | Do lỗi mạng, rate-limit hoặc lỗi logic |
| **Tổng thời gian thực hiện** | **6.23 giây** | Thời gian hoàn tất toàn bộ 5 người |
| **Mức tải song song thực tế** | **2 sales** | Giới hạn số người hỏi cùng 1 thời điểm |

---

## ⏱️ Phân Tích Thời Gian Phản Hồi (Latency Analysis)

* **Thời gian phản hồi trung bình (Average):** `2172 ms` (~2.17s)
* **Thời gian phản hồi nhanh nhất (Min):** `284 ms`
* **Thời gian phản hồi lâu nhất (Max):** `5581 ms` (Tải RAG hoặc SQL phức tạp)
