...
set "SRC=%~dp0.."
set "TMP_DIR=%~dp0..\..\Medstand_TuyetDoiNhe_Tam"
set "ZIP_FILE=%~dp0..\..\Medstand_BanGiao_Khach.zip"

if exist "%TMP_DIR%" rmdir /s /q "%TMP_DIR%"
if exist "%ZIP_FILE%" del /q "%ZIP_FILE%"

echo [1/3] Đang lọc file dọn rác ra thư mục tạm...
robocopy "%SRC%" "%TMP_DIR%" /MIR /XD .git .cursor .venv .logs npm_global npm_cache .cache .bin qdrant_storage node_modules __pycache__ /XF *.zip Tao_File_Gui_Khach.bat /NJH /NJS /NDL /NC /NS /NP /R:0 /W:0 >nul
