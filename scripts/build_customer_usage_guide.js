...
function buildBody() {
  ...
  body.push(callout('Không gửi liên tục', 'Một truy vấn thường cần khoảng 1–5 giây. Nếu quá 15 giây, ghi nhận là phản hồi chậm; không nhấn nút gửi nhiều lần.', 'warning'));
