...
BEGIN TRY
    ...
    WHERE ISNULL(isCustomer, 0) = 1 
      AND ObjectID IN (
          ...
          WHERE EmployeeID IN ('MED0330','MED0229','MED0637','MED0096','QLBH024','MED0134')
      );
    ...
    FROM CF_ItemTbl 
    WHERE ItemID IN (
        'A008', 'A012', 'A014', 'A015', 'A016', 'A017', 'B004', 'B005', 'B006', 'B007', 
        'B009', 'B040', 'B044', 'B012', 'B015', 'B019', 'B020', 'B021', 'B022', 'B026', 
        'B028', 'B029', 'B036', 'B037', 'B039', 'B041', 'B042', 'C016', 'C017', 'C018', 
        'D012', 'D017', 'D018', 'D020', 'D021', 'D022', 'D023', 'E004', 'F003', 'F005', 
        'F009', 'F010', 'F011', 'F012', 'G004', 'G005', 'G010', 'G011', 'H006', 'H008', 
        'S036', 'H011', 'H012', 'H016', 'H014', 'J003', 'J008', 'K030', 'K031', 'K032', 
        'K033', 'L002', 'L003', 'L009', 'L010', 'L011', 'L012', 'M014', 'M015', 'M018', 
        'M027', 'M028', 'M029', 'M030', 'N004', 'N014', 'N017', 'N018', 'O006', 'O007', 
        'O005', 'S030', 'S031', 'S032', 'S033', 'T022', 'T023', 'V002', 'V016', 'V017', 
        'V018', 'V019', 'X011', 'X012', 'Y011', 'Y012', 'Y014', 'Y015', 'Y016', 'YT001', 
        'YT002', 'YT003', 'Z002'
    );
