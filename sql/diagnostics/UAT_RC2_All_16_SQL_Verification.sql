...
VALUES
    (1,  N'API_GoiYDonHang_AI',            '@goi_ydon_hang',       N'API_GoiYDonHang_AI',           N'sql/Module_01_API_GoiYDonHang_AI.sql',                '61b859fd343af3930f63b74c3b582e770f0263bb9a375b9c9598747a8c786c19', N'OBJECT_ID(''tempdb..#AllowedObjects'') IS NOT NULL', N'@BracketClose > @BracketOpen'),
    (2,  N'API_SanPhamTrongTam_AI',         '@san_pham_trong_tam',  N'API_SanPhamTrongTam_AI',       N'sql/Module_10_API_SanPhamTrongTam_AI.sql',           '3d297fb2585fe9befd57f50ebc839b13f1d4105d0eb088ef2c8ee9d3af5f90fa', N'OBJECT_ID(''tempdb..#FocusItems'') IS NOT NULL', NULL),
    (3,  N'API_TraCuuSanPham_AI',           '@tra_cuu_san_pham',    N'API_TraCuuSanPham_AI',         N'sql/Module_10_API_TraCuuSanPham_AI.sql',             '4bd9a544c9c9c528538206d5790bcaae320160d345c2ef037a33b32ec05186e6', N'OBJECT_ID(''tempdb..#MatchedItems'') IS NOT NULL', N'OBJECT_ID(''tempdb..#FinalPrices'') IS NOT NULL'),
    (4,  N'API_TuyenBanHang_AI',            '@tuyen_ban_hang',      N'API_TuyenBanHang_AI',          N'sql/Module_02_API_TuyenBanHang_AI.sql',               '43221682f047f5a599fe0deeed81e2d71653f751a31f4f0fa7b4ed1f96d2d394', N'OBJECT_ID(''tempdb..#AllowedObjects'') IS NOT NULL', N'@BracketClose > @BracketOpen'),
    (5,  N'API_ChamDiemKH_AI',              '@cham_diem_kh',        N'API_ChamDiemKH_AI',            N'sql/Module_03_API_ChamDiemKH_AI.sql',                 '8ca6d2017971a28e0a242f4fd5ba892817ca9975c17c0cd31c5bb23961329157', N'OBJECT_ID(''tempdb..#AllowedObjects'') IS NOT NULL', N'OBJECT_ID(''tempdb..#Segmented'') IS NOT NULL'),
    (6,  N'API_TichLuy_AI',                 '@tich_luy',            N'API_TichLuy_AI',               N'sql/Module_04_API_TichLuy_AI.sql',                    'ade58d5754b513bae92096860dcb1dc627ccb520d58785f119ba35da7c4d6cb8', N'OBJECT_ID(''tempdb..#TrongTam'') IS NOT NULL', N'OBJECT_ID(''tempdb..#ItemsBought'') IS NOT NULL'),
    (7,  N'API_UpsellGoiY_AI',              '@upsell_goi_y',        N'API_UpsellGoiY_AI',            N'sql/Module_05_API_UpsellGoiY_AI.sql',                 'd671b65c2016d67d87045b99cdafe4125fbeebb3f56b5941c3ffe3bab52dd6e0', N'OBJECT_ID(''tempdb..#TrongTam'') IS NOT NULL', N'@BracketClose > @BracketOpen'),
    (8,  N'API_DeXuatKhuyenMai_AI',         '@de_xuat_khuyen_mai',  N'API_DeXuatKhuyenMai_AI',       N'sql/Module_06_API_DeXuatKhuyenMai_AI.sql',            '1d8738988c5a1d74ef07c92f743cd3f71eeb83f3c6ba9d224c9210ed9da4688c', N'OBJECT_ID(''tempdb..#StockByLot'') IS NOT NULL', N'OBJECT_ID(''tempdb..#SalesVelocity'') IS NOT NULL'),
    (9,  N'API_CongNoChiTiet_AI',           '@cong_no_chi_tiet',    N'API_CongNoChiTiet_AI',         N'sql/Module_Common_API_CongNoChiTiet_AI.sql',         '2c0513471cf5314541e55a362e85e76cdebc323927a7c23bb2c5d24534710009', N'@BracketClose > @BracketOpen', NULL),
    (10, N'API_CongNoKhachHang_AI',         '@cong_no_khach_hang',  N'API_CongNoKhachHang_AI',       N'sql/Module_Common_API_CongNoKhachHang_AI.sql',       '92c4b6211c27704859117eaba114a976c78c08621a2f13d0345f5c92fd8becaa', N'@BracketClose > @BracketOpen', NULL),
    (11, N'API_DanhMuc_Core_AI',            '@danh_muc',            N'API_DanhMuc_AI',               N'sql/Module_Common_API_DanhMuc_AI.sql',               '308578daba4c41589a3f69c4b871688d152836756434bc7d370facacc3a35901', N'OBJECT_ID(''tempdb..#TempAllKH'') IS NOT NULL', N'OBJECT_ID(''tempdb..#TempSP'') IS NOT NULL'),
    (12, N'API_DoanhSo_AI',                 '@doanh_so',            N'API_DoanhSo_AI',               N'sql/Module_Common_API_DoanhSo_AI.sql',               '2ea9566c64b007255507d566b5dfd8c5f8eb2c92690c4f5619fd11d542ef49b8', N'@BracketClose > @BracketOpen', NULL),
    (13, N'API_DonHangChiTiet_Insert_AI',   '@lap_don_hang',        N'API_DonHangChiTiet_Insert_AI', N'sql/Module_Common_API_DonHangChiTiet_Insert_AI.sql', '3513ad8c33f3be5f3e18686591ba7b3e3220721097d2e28aef9ba1f0ae8ffc05', N'OBJECT_ID(''tempdb..#Items'') IS NOT NULL', NULL),
    (14, N'API_DonHang_AI',                 '@don_hang',            N'API_DonHang_AI',               N'sql/Module_Common_API_DonHang_AI.sql',               'de59d3c39003d06c88769cce8d8ea2f8e0d1138a2649539aec8ec9cbeb54741b', N'@BracketClose > @BracketOpen', NULL),
    (15, N'API_HoaDon_AI',                  '@hoa_don',             N'API_HoaDon_AI',                N'sql/Module_Common_API_HoaDon_AI.sql',                'df497486cccb3c0d193e7840890dd5491992816344f1ff732f253d11e697cee3', N'OBJECT_ID(''tempdb..#BC'') IS NOT NULL', NULL);
