...
const Router = (() => {
  ...
  const ROUTES = [
    ...
    { path: 'chatbot', template: 'chatbot-widget/template/chatbot.html', scripts: ['chatbot-widget/js/chatbot-suggestions.js', 'chatbot-widget/js/chatbot-api-engine.js?v=1775731006', 'chatbot-widget/js/chatbot.js?v=1775731006'], css: ['chatbot-widget/css/chatbot.css?v=1775731006', 'chatbot-widget/css/chatbot-api-engine.css?v=1775731006'], auth: true, nav: 'home', title: 'AI Trợ lý' },
