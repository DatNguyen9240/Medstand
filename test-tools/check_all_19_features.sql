-- =============================================================================
-- SCRIPT KIỂM THỬ TOÀN DIỆN 19 TÍNH NĂNG MEDSTAND AI (BẢN ĐÃ SỬA CỘT STT 04)
-- Đối tượng: Cặp đôi Mai Anh Tuấn (QLBH013.MED) & Đoàn Văn Thế (NAMDINHB.MED)
...
PRINT N'================================================================================';
PRINT N'                    BẮT ĐẦU KIỂM THỬ HỆ THỐNG DỮ LIỆU MEDSTAND AI               ';
PRINT N'================================================================================';
...
EXEC dbo.API_DoanhSo_AI @Username = 'NAMDINHB.MED', @LoaiBaoCao = 'NhanVien';
...
EXEC dbo.API_DonHang_AI @Username = 'NAMDINHB.MED', @TopN = 50;
...
EXEC dbo.API_GoiYDonHang_AI @Username = 'NAMDINHB.MED', @MaKhachHang = 'HYA107', @TopN = 5;
...
EXEC dbo.API_UpsellGoiY_AI @Username = 'NAMDINHB.MED', @MaKhachHang = 'HYA107', @TopN = 5;
...
EXEC dbo.API_TraCuuSanPham_AI @Username = 'NAMDINHB.MED', @timkiem = 'Antrinano', @TopN = 3;
...
-- 2. TDV xem công nợ
EXEC dbo.API_CongNoKhachHang_AI @Username = 'NAMDINHB.MED', @DenNgay = '2026-05-25';
...
EXEC dbo.API_CongNoChiTiet_AI @Username = 'NAMDINHB.MED', @MaKhachHang = 'HYA107', @DenNgay = '2026-05-25';
...
-- 2. TDV tra cứu
EXEC dbo.API_HoaDon_AI @Username = 'NAMDINHB.MED', @timkiem = 'HYA107';
...
EXEC dbo.API_TichLuy_AI @Username = 'NAMDINHB.MED', @MaKhachHang = 'HYA107';
...
EXEC dbo.API_TuyenBanHang_AI @Username = 'NAMDINHB.MED', @TopN = 100;
...
EXEC dbo.API_GoiYDonThuoc_AI @Username = 'NAMDINHB.MED', @timkiem = 'Amoxicillin, Vitamin C';
...
EXEC dbo.API_DeXuatKhuyenMai_AI @Username = 'NAMDINHB.MED';
...
EXEC dbo.API_SanPhamTrongTam_AI @Username = 'NAMDINHB.MED';
...
EXEC dbo.API_DanhMuc_AI @Username = 'NAMDINHB.MED', @Type = 'sanpham';
...
EXEC dbo.API_DanhSachTonKho_AI @Username = 'NAMDINHB.MED', @ItemID = 'A003';
...
EXEC dbo.API_KiemTraKhaoSat_AI @Username = 'NAMDINHB.MED', @Ngay = NULL;
...
SELECT 
    ...
    N'Toàn bộ hệ thống cơ sở dữ liệu của Medstand AI đều đang lưu trữ và phân quyền dữ liệu cực kỳ chuẩn xác cho cặp đôi Mai Anh Tuấn & Đoàn Văn Thế.' AS [msg],
