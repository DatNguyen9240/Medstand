-- =============================================================================
-- SCRIPT KIỂM THỬ TOÀN DIỆN 19 TÍNH NĂNG MEDSTAND AI (CẶP 3 - MIỀN TRUNG)
-- Đối tượng: Cặp 3 - QL Nguyễn Thế Anh (QLBH005.MED) & TDV Lê Thị Hiền (HUEB.MED)
...
PRINT N'================================================================================';
PRINT N'                BẮT ĐẦU KIỂM THỬ CẶP 3: QLBH005.MED & HUEB.MED                 ';
PRINT N'================================================================================';
...
EXEC dbo.API_DoanhSo_AI @Username = 'QLBH005.MED', @LoaiBaoCao = 'NhanVien';
-- 2. Xem dưới quyền TDV
EXEC dbo.API_DoanhSo_AI @Username = 'HUEB.MED', @LoaiBaoCao = 'NhanVien';

-- -----------------------------------------------------------------------------
-- STT 02: Bảo mật — phân quyền
-- Kỳ vọng: Hệ thống từ chối hiển thị dữ liệu ngoài vùng phụ trách (QL Miền Trung không xem được dữ liệu Miền Bắc).
-- -----------------------------------------------------------------------------
PRINT N'>>> STT 02: Bảo mật — phân quyền (Xem chéo vùng)';
-- Quản lý Miền Trung thử truyền ID của vùng Miền Bắc (QLMB) -> Kết quả chỉ lọc ra vùng MT
EXEC dbo.API_DoanhSo_AI @Username = 'QLBH005.MED', @ManagerID = 'QLBH013.MED', @LoaiBaoCao = 'NhanVien';
...
EXEC dbo.API_DonHang_AI @Username = 'QLBH005.MED', @TopN = 50;
-- 2. TDV tra cứu đơn hàng
EXEC dbo.API_DonHang_AI @Username = 'HUEB.MED', @TopN = 50;
...
EXEC dbo.API_GoiYDonHang_AI @Username = 'HUEB.MED', @MaKhachHang = 'DNA014', @TopN = 5;
...
EXEC dbo.API_UpsellGoiY_AI @Username = 'HUEB.MED', @MaKhachHang = 'DNA014', @TopN = 5;
...
EXEC dbo.API_TraCuuSanPham_AI @Username = 'HUEB.MED', @timkiem = 'Antrinano', @TopN = 3;
...
EXEC dbo.API_CongNoKhachHang_AI @Username = 'QLBH005.MED', @DenNgay = '2026-05-25';
-- 2. TDV xem công nợ
EXEC dbo.API_CongNoKhachHang_AI @Username = 'HUEB.MED', @DenNgay = '2026-05-25';
...
EXEC dbo.API_CongNoChiTiet_AI @Username = 'HUEB.MED', @MaKhachHang = 'DNA014', @DenNgay = '2026-05-25';
...
-- 1. Quản lý tra cứu
EXEC dbo.API_HoaDon_AI @Username = 'QLBH005.MED', @timkiem = 'DNA014';
-- 2. TDV tra cứu
EXEC dbo.API_HoaDon_AI @Username = 'HUEB.MED', @timkiem = 'DNA014';
...
EXEC dbo.API_TichLuy_AI @Username = 'HUEB.MED', @MaKhachHang = 'DNA014';
...
EXEC dbo.API_TuyenBanHang_AI @Username = 'QLBH005.MED', @TopN = 100;
-- 2. Xem lịch tuyến của TDV (Xem cá nhân)
EXEC dbo.API_TuyenBanHang_AI @Username = 'HUEB.MED', @TopN = 100;
...
EXEC dbo.API_GoiYDonThuoc_AI @Username = 'HUEB.MED', @timkiem = 'Amoxicillin, Vitamin C';
...
EXEC dbo.API_DeXuatKhuyenMai_AI @Username = 'HUEB.MED';
...
EXEC dbo.API_SanPhamTrongTam_AI @Username = 'HUEB.MED';
...
EXEC dbo.API_DanhMuc_AI @Username = 'HUEB.MED', @Type = 'sanpham';
...
EXEC dbo.API_DanhSachTonKho_AI @Username = 'HUEB.MED', @ItemID = 'A003';
...
EXEC dbo.API_KiemTraKhaoSat_AI @Username = 'HUEB.MED', @Ngay = NULL;
...
SELECT 
    ...
    N'Toàn bộ hệ thống cơ sở dữ liệu của Medstand AI đều đang lưu trữ và phân quyền dữ liệu cực kỳ chuẩn xác cho cặp đôi Nguyễn Thế Anh & Lê Thị Hiền.' AS [msg],
