-- =============================================================================
-- SCRIPT KIỂM THỬ TOÀN DIỆN 19 TÍNH NĂNG MEDSTAND AI (CẶP 5 - MIỀN NAM)
-- Đối tượng: Cặp 5 - QL Trần Văn Luân (QLMN2) & TDV Nguyễn Thị Thu Thảo (CanThoA)
...
PRINT N'================================================================================';
PRINT N'                    BẮT ĐẦU KIỂM THỬ CẶP 5: QLMN2 & CanThoA                     ';
PRINT N'================================================================================';
...
EXEC dbo.API_DoanhSo_AI @Username = 'QLMN2', @LoaiBaoCao = 'NhanVien';
-- 2. Xem dưới quyền TDV
EXEC dbo.API_DoanhSo_AI @Username = 'CanThoA', @LoaiBaoCao = 'NhanVien';

-- -----------------------------------------------------------------------------
-- STT 02: Bảo mật — phân quyền
-- Kỳ vọng: Hệ thống từ chối hiển thị dữ liệu ngoài vùng phụ trách (QL Miền Nam không xem được dữ liệu Miền Bắc).
-- -----------------------------------------------------------------------------
PRINT N'>>> STT 02: Bảo mật — phân quyền (Xem chéo vùng)';
-- Quản lý Miền Nam thử truyền ID của vùng Miền Bắc (QLBH013.MED) -> Kết quả chỉ lọc ra vùng MN
EXEC dbo.API_DoanhSo_AI @Username = 'QLMN2', @ManagerID = 'QLBH013.MED', @LoaiBaoCao = 'NhanVien';
...
EXEC dbo.API_DonHang_AI @Username = 'QLMN2', @TopN = 50;
-- 2. TDV tra cứu đơn hàng
EXEC dbo.API_DonHang_AI @Username = 'CanThoA', @TopN = 50;
...
EXEC dbo.API_GoiYDonHang_AI @Username = 'CanThoA', @MaKhachHang = 'DNA014', @TopN = 5;
...
EXEC dbo.API_UpsellGoiY_AI @Username = 'CanThoA', @MaKhachHang = 'DNA014', @TopN = 5;
...
EXEC dbo.API_TraCuuSanPham_AI @Username = 'CanThoA', @timkiem = 'Antrinano', @TopN = 3;
...
EXEC dbo.API_CongNoKhachHang_AI @Username = 'QLMN2', @DenNgay = '2026-05-25';
-- 2. TDV xem công nợ
EXEC dbo.API_CongNoKhachHang_AI @Username = 'CanThoA', @DenNgay = '2026-05-25';
...
EXEC dbo.API_CongNoChiTiet_AI @Username = 'CanThoA', @MaKhachHang = 'DNA014', @DenNgay = '2026-05-25';
...
-- 1. Quản lý tra cứu
EXEC dbo.API_HoaDon_AI @Username = 'QLMN2', @timkiem = 'DNA014';
-- 2. TDV tra cứu
EXEC dbo.API_HoaDon_AI @Username = 'CanThoA', @timkiem = 'DNA014';
...
EXEC dbo.API_TichLuy_AI @Username = 'CanThoA', @MaKhachHang = 'DNA014';
...
EXEC dbo.API_TuyenBanHang_AI @Username = 'QLMN2', @TopN = 100;
-- 2. Xem lịch tuyến của TDV (Xem cá nhân)
EXEC dbo.API_TuyenBanHang_AI @Username = 'CanThoA', @TopN = 100;
...
EXEC dbo.API_GoiYDonThuoc_AI @Username = 'CanThoA', @timkiem = 'Amoxicillin, Vitamin C';
...
EXEC dbo.API_DeXuatKhuyenMai_AI @Username = 'CanThoA';
...
EXEC dbo.API_SanPhamTrongTam_AI @Username = 'CanThoA';
...
EXEC dbo.API_DanhMuc_AI @Username = 'CanThoA', @Type = 'sanpham';
...
EXEC dbo.API_DanhSachTonKho_AI @Username = 'CanThoA', @ItemID = 'A003';
...
EXEC dbo.API_KiemTraKhaoSat_AI @Username = 'CanThoA', @Ngay = NULL;
...
SELECT 
    ...
    N'Toàn bộ hệ thống cơ sở dữ liệu của Medstand AI đều đang lưu trữ và phân quyền dữ liệu cực kỳ chuẩn xác cho cặp đôi Trần Văn Luân & Nguyễn Thị Thu Thảo.' AS [msg],
