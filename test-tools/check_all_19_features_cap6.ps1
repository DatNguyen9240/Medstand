...
Write-Output "=========================================================="
Write-Output "MEDSTAND AI - THUC THI KIEM TRA DU LIEU 19 TINH NANG (CAP 6)"
Write-Output "Cap: QLMD1 (Nguyen Van Thai) - BinhPhuocA (Nguyen Quoc Tuan)"
...
$dsQL = Execute-Query "EXEC API_DoanhSo_AI @Username = 'QLMD1', @LoaiBaoCao = 'NhanVien'"
$dsTDV = Execute-Query "EXEC API_DoanhSo_AI @Username = 'BinhPhuocA', @LoaiBaoCao = 'NhanVien'"
if ($dsQL) { Write-Output "  * Quan ly QLMD1: Xem thay $($dsQL.Rows.Count) nhan vien trong vung." }
if ($dsTDV) { 
...
Write-Output "--- STT 02: Bao Mat Phan Quyen (Quan ly MN xem Mien Trung) ---"
$dsCross = Execute-Query "EXEC API_DoanhSo_AI @Username = 'QLMD1', @ManagerID = 'QLBH010.MED', @LoaiBaoCao = 'NhanVien'"
$isBlocked = $true
if ($dsCross) {
...
$dhQL = Execute-Query "EXEC API_DonHang_AI @Username = 'QLMD1', @TopN = 5000"
$dhTDV = Execute-Query "EXEC API_DonHang_AI @Username = 'BinhPhuocA', @TopN = 5000"
if ($dhQL) { Write-Output "  * Quan ly QLMD1: Xem thay tong cong $($dhQL.Rows.Count) don hang cua vung." }
...
$cnQL = Execute-Query "EXEC API_CongNoKhachHang_AI @Username = 'QLMD1', @DenNgay = '2026-05-25'"
$cnTDV = Execute-Query "EXEC API_CongNoKhachHang_AI @Username = 'BinhPhuocA', @DenNgay = '2026-05-25'"
if ($cnQL) { Write-Output "  * Quan ly QLMD1: Xem thay $($cnQL.Rows.Count) khach hang no trong vung." }
if ($cnTDV) { 
...
$hdQL = Execute-Query "EXEC API_HoaDon_AI @Username = 'QLMD1', @timkiem = 'DNA014'"
...
$tlQL = Execute-Query "EXEC API_TichLuy_AI @Username = 'QLMD1', @MaKhachHang = 'DNA014'"
...
$tuyenQL = Execute-Query "EXEC API_TuyenBanHang_AI @Username = 'QLMD1', @TopN = 500"
