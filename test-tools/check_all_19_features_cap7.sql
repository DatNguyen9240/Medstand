-- =============================================================================
-- SCRIPT KIỂM THỬ TOÀN DIỆN 19 TÍNH NĂNG MEDSTAND AI (CẶP 7 - MIỀN NAM)
-- Đối tượng: Cặp 7 - QL Ngô Đức Hùng (QLBH024.MED) & TDV Nguyễn Quốc Tuấn (BinhPhuocA)
...
PRINT N'================================================================================';
PRINT N'                BẮT ĐẦU KIỂM THỬ CẶP 7: QLBH024.MED & BinhPhuocA                ';
PRINT N'================================================================================';
...
EXEC dbo.API_DoanhSo_AI @Username = 'QLBH024.MED', @LoaiBaoCao = 'NhanVien';
...
EXEC dbo.API_DoanhSo_AI @Username = 'QLBH024.MED', @ManagerID = 'QLBH013.MED', @LoaiBaoCao = 'NhanVien';
...
EXEC dbo.API_DonHang_AI @Username = 'QLBH024.MED', @TopN = 50;
...
EXEC dbo.API_CongNoKhachHang_AI @Username = 'QLBH024.MED', @DenNgay = '2026-05-25';
-- 2. TDV xem công nợ
...
-- 1. Quản lý tra cứu
EXEC dbo.API_HoaDon_AI @Username = 'QLBH024.MED', @timkiem = 'DNA014';
-- 2. TDV tra cứu
...
EXEC dbo.API_TuyenBanHang_AI @Username = 'QLBH024.MED', @TopN = 100;
...
SELECT 
    ...
    N'Toàn bộ hệ thống cơ sở dữ liệu của Medstand AI đều đang lưu trữ và phân quyền dữ liệu cực kỳ chuẩn xác cho cặp đôi Ngô Đức Hùng & Nguyễn Quốc Tuấn.' AS [msg],
